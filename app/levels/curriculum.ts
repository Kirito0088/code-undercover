...
export const BEGINNER_CURRICULUM: LevelNode[] = [
    { id: "beg-1", order: 1, title: "Missing Semicolon", description: "Infiltrate target servers by mastering C printf syntax and standard formatted system outputs.", difficulty: "EASY", auraReward: 100, isReal: true, track: "ALPHA" },
    { id: "beg-2", order: 2, title: "Loop of No Return", description: "Capture and declare local variables (int, float, char) and read terminal inputs using scanf.", difficulty: "EASY", auraReward: 100, isReal: true, track: "ALPHA" },
    { id: "beg-3", order: 3, title: "Null Pointer Alibi", description: "Override complex decision pathways using composite nested conditional controls and relational branches.", difficulty: "EASY", auraReward: 214, isReal: true, track: "ALPHA" },
    { id: "beg-4", order: 4, title: "Recursion Rescue", description: "Decrypt transmission packages continuously using iterative for, while, and do-while loop constructs.", difficulty: "EASY", auraReward: 258, isReal: true, track: "ALPHA" },
    { id: "beg-5", order: 5, title: "Off-By-One Heist", description: "Verify modular sub-systems and inject operational code parameters using reusable C functions.", difficulty: "EASY", auraReward: 300, isReal: true, track: "ALPHA" },
    { id: "beg-6", order: 6, title: "Race Condition", description: "Perform terminal computations by executing operations using standard arithmetic precedence rules.", difficulty: "EASY", auraReward: 110, isReal: true, track: "ALPHA" },
    { id: "beg-7", order: 7, title: "Ghost In Machine", description: "Construct structural pathways using standard conditional decision blocks (if, else if, else).", difficulty: "EASY", auraReward: 110, isReal: true, track: "ALPHA" },
    { id: "beg-8", order: 8, title: "Merge Conflict", description: "Evaluate complex conditions by chaining binary logical parameters using &&, ||, and ! operators.", difficulty: "EASY", auraReward: 110, isReal: true, track: "ALPHA" },
    { id: "beg-9", order: 9, title: "Stack Overflow", description: "Optimize conditional flow structures with multiple routing paths using switch-case statements.", difficulty: "EASY", auraReward: 110, isReal: true, track: "ALPHA" },
    { id: "beg-10", order: 10, title: "Silent Crash", description: "Infiltrate and extract data logs continuously using basic pre-test while loops.", difficulty: "EASY", auraReward: 110, isReal: true, track: "ALPHA" },
    { id: "beg-11", order: 11, title: "Zombie Process", description: "Develop counter-controlled iteration routines using optimized C for-loop parameters.", difficulty: "EASY", auraReward: 110, isReal: true, track: "ALPHA" },
    { id: "beg-12", order: 12, title: "Resource Leak", description: "Exert absolute authority over looping execution using structured break and continue signals.", difficulty: "EASY", auraReward: 110, isReal: true, track: "ALPHA" },
    { id: "beg-13", order: 13, title: "Deadlock Trap", description: "Process complex multi-dimensional data grids by executing loop operations inside loop frames.", difficulty: "EASY", auraReward: 110, isReal: true, track: "ALPHA" },
    { id: "beg-14", order: 14, title: "Memory Corruption", description: "Encapsulate executable actions into isolated, modular parameters using void functions.", difficulty: "EASY", auraReward: 110, isReal: true, track: "ALPHA" },
    { id: "beg-15", order: 15, title: "Infinite Loop", description: "Develop standalone functional subroutines that process inputs and yield exact return parameters.", difficulty: "EASY", auraReward: 110, isReal: true, track: "ALPHA" },
    { id: "beg-16", order: 16, title: "Duplicate Key", description: "Manage system memory scope and stack boundaries by regulating local vs global variable definitions.", difficulty: "EASY", auraReward: 110, isReal: true, track: "ALPHA" },
    ...
    { id: "beg-18", order: 18, title: "Broken Build", description: "Store and process null-terminated character buffers (\\0) using fundamental string properties.", difficulty: "EASY", auraReward: 110, isReal: true, track: "ALPHA" },
    { id: "beg-19", order: 19, title: "Phantom Bug", description: "Read exact heap addresses directly using pointers, reference (&), and dereference (*) operators.", difficulty: "EASY", auraReward: 110, isReal: true, track: "ALPHA" },
    { id: "beg-20", order: 20, title: "Final System Lockdown", description: "Provision dynamic memory structures on the database heap securely using malloc and free calls.", difficulty: "EASY", auraReward: 110, isReal: true, track: "ALPHA" },
]
