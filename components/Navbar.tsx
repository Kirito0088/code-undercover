    ...
    return (
        <header className={styles.navbar}>
            ...
            <div className={styles.inner}>
                ...
                <Link href="/profile" className={`${TAB_CLASS} ${PROFILE_TAB_CLASS} flex items-center gap-1.5`}>
            ...
            {/* Mobile Navigation Dropdown — profile now direct */}
            <div className="relative ml-auto md:hidden flex items-center">
                <MobileNav isAuthenticated={!!(session && userStats)}>
                    <Link href="/profile" className="text-sm font-medium text-[#8F9F8F] hover:text-[#E2E8F0]">
                        Profile
                    </Link>
                </MobileNav>
            </div>
