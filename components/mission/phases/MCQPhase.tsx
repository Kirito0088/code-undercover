...
export function MCQPhase({ mission, onComplete }: MCQPhaseProps) {
    ...
    return (
        <div className="absolute inset-0 flex items-center justify-center p-4 sm:p-8 bg-[#050505] z-30 overflow-y-auto">
                ...
                <div className="bg-gray-900/80 border border-gray-800 p-5 sm:p-8 rounded-2xl shadow-2xl backdrop-blur-md">
                    ...
                    <div className="mt-6 sm:mt-8 flex justify-end">
                        <button
                            ...
                            className="flex items-center gap-2 bg-blue-600 hover:bg-blue-500 disabled:opacity-50 disabled:hover:bg-blue-600 text-white px-6 py-2.5 sm:px-8 sm:py-3 rounded-lg font-bold tracking-widest font-mono uppercase transition-all shadow-[0_0_15px_rgba(59,130,246,0.4)] text-xs sm:text-sm"
                        >
